...
ava_1.default("renders", function (t) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                changeset = new Changeset_1.Changeset({ property: "test value" });
                input = m(Input_1.Input, {
...
ava_1.default("updates changeset on input", function (t) { return __awaiter(_this, void 0, void 0, function () {
    var changeset, input, element;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                changeset = new Changeset_1.Changeset({ property: "original value" });
                input = m(Input_1.Input, { changeset: changeset, name: "property" });
                return [4 /*yield*/, Mock.mount(input)];
            case 1:
                element = _a.sent();
