...
ava_1.default("findElementForText successfully finds text", function (t) { return __awaiter(_this, void 0, void 0, function () {
    var element;
...
ava_1.default("findElementForText successfully doesn't find text", function (t) { return __awaiter(_this, void 0, void 0, function () {
    var element;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Mock.mount(m("div", [
